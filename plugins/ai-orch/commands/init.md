---
description: AI Orch 최초 필수 초기화. local 상태, settings, 보호 정책, CLAUDE.md symlink 준비
argument-hint: ""
...
3. `.ai-orch/init.json`, settings, 보호 정책, `.gitignore`, `CLAUDE.md -> AGENTS.md` symlink가 준비되었는지 요약한다.
